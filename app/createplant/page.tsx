...
//Tailwind Class for Data Entry Fields
    ...
    return (
        <div className='mt-20 mx-auto max-w-xl bg-amber-100 rounded-3xl'>
            ...
            <Form action={submitCreateForm} className='mt-16 grid grid-cols-1 gap-8 mx-auto max-w-md pb-6'>
                ...
                <label> Watering Interval (Hours): <input name = "waterInterval" type = "number" defaultValue = {48}  className = {formField}/> </label>
                <label> Time Until Next Watering (Hours): <input name = "timeTillWater" type = "number" className = {formField}/> </label>
